...
def process_country(country):
    ...
    try:
        ...
        for resolution in data['resolutions']:
            if resolution['country_name'] == 'India' or resolution['country_to_attack'] == 'India':
                if resolution['country_name'] != 'India':
                    print(f"ID: {resolution['id']} == skanuar në {country}")
                elif resolution['country_to_attack'] != 'India':
                    print(f"ID: {resolution['id']} == skanuar në {country}")
                else:
                    print(f"Both fields reference India, ID: {resolution['id']}")
